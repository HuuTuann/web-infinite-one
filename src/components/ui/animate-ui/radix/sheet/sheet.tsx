          ...
          <SheetPrimitive.Content asChild forceMount {...props}>
            ...
            >
              ...
              <SheetPrimitive.Close
                ...
                className="data-[state=open]:bg-secondary absolute top-4 right-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none"
              >
                <X className="h-4 w-4" />
