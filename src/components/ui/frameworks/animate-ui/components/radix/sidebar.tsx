...
import { Tooltip } from "@/frameworks-animate-ui/components/animate";
import { Sheet } from "@/frameworks-animate-ui/components/radix";
import { Highlight } from "@/frameworks-animate-ui/primitives/effects";
import {
  ButtonShadcn,
  InputShadcn,
  SeparatorShadcn,
...
import { cn, getStrictContext } from "@/lib";
...
type SidebarTriggerProps = React.ComponentProps<typeof ButtonShadcn>;
...
type SidebarInputProps = React.ComponentProps<typeof InputShadcn>;
...
type SidebarSeparatorProps = React.ComponentProps<typeof SeparatorShadcn>;
...
function SidebarMenuSubButton({
  ...
  return (
    <Highlight.Item activeClassName="bg-sidebar-accent text-sidebar-accent-foreground rounded-md">
      <Comp
